...
class TableEventsForEditExample extends StatefulWidget {
  final int? id_user;
  final int? bookingId;
  const TableEventsForEditExample({Key? key, this.id_user, this.bookingId})
      : super(key: key);
  @override
  _TableEventsForEditExampleState createState() =>
      _TableEventsForEditExampleState();
}

class _TableEventsForEditExampleState extends State<TableEventsForEditExample> {
