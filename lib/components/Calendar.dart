...
import 'package:privacy_maid_flutter/widgets/calendarwidget.dart';
    ...
    return GestureDetector(
      ...
      child: Column(
        children: [
          ...
          CalendarWidget(
            selectedDate: selectedDate, // ส่งวันที่ที่เลือก
            maidWorklist: maidWorklist, // ส่งข้อมูล maidWork
          ),
        ],
      ),
    );
